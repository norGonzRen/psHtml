...
class Ps_checkout2152AdminContainer extends Container
{
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.6.1.24', 'C:\\laragon\\www\\prestashop16');
    }
